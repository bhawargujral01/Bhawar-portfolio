      ...
      <div className="flex justify-center relative my-20 z-10">
        <div className="max-w-[89vw] md:max-w-2xl  lg:max-w-[60vw] flex flex-col items-center">
          <h2 className="uppercase tracking-widest text-xs text-center text-blue-200 max-w-80">
            Having 3+ years of experience in
          </h2>
          <TextGenerateEffect
            className="text-center text-[40px] md:text-5xl lg:text-6xl"
            words="Crafting scalable solutions with clean code and cloud-native precision"
          />
          <p className="text-center md:tracking-wider mb-4 xt-sm  md: text-lg lg:text-2xl">
            Hi, I am <span className="text-purple">Bhawar Gujral</span>, a
            Fullstack developer Based in Toronto.
          </p>
